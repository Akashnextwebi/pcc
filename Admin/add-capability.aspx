                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title"><%=Request.QueryString["id"] !=null?"Update":"Add" %> Capability Detail</h5>
                        </div>
                        <div class="card-body">
                            <div class="row mb-2">
                                <div class="col-lg-6">
                            ...
                            <div class="col-lg-12 mb-3">
                                ...
                                <asp:Button runat="server" ID="btnNew" CssClass="btn btn-info" Visible="false" Text="Add New Capability" OnClick="btnNew_Click" />
                            </div>
                        </div>
                    </div>
                </div>
