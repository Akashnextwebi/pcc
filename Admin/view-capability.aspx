            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">View Competencies</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="/Admin/">Dashboard</a></li>
                                <li class="breadcrumb-item"><a href="javascript: void(0);">Competencies</a></li>
                                <li class="breadcrumb-item active">View Competencies</li>
                            </ol>
                        </div>
            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">View Competencies</h5>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-12">
