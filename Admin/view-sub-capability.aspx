<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="view-sub-capability.aspx.cs" Inherits="Admin_view_sub_capability" %>
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Manage SubCapability</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="/Admin/">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="javascript: void(0);">SubCapability</a></li>
                            <li class="breadcrumb-item active">Manage SubCapability</li>
                        </ol>
                    </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">Manage SubCapability</h5>
                    </div>
                    <div class="card-body">
           ...
           $(document.body).on('click', '.deleteItem', function () {
               ...
               Swal.fire({
                   ...
                   if (result.value) {
                       $.ajax({
                           type: 'POST',
                           url: "view-sub-capability.aspx/Delete",
                           data: "{id: '" + id + "'}",
