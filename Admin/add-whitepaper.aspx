        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row mb-2">
                                <div class="col-lg-6">
                                    <label class="text-muted">Whitepaper Title<sup class="text-danger">*</sup></label>
                                ...
                                <div class="col-lg-6">
                                    <label class="text-muted">Whitepaper URL<sup class="text-danger">*</sup></label>
                                ...
                                <div class="col-lg-6">
                                    <label class="text-muted">Whitepaper Heading<sup class="text-danger">*</sup></label>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-12 mb-3">
                                    <label class="text-muted">Detail Image<sup class="text-danger">*</sup></label>
                                ...
                                <div class="col-lg-12 mb-3">
                                    <label class="text-muted">Banner Image<sup class="text-danger">*</sup></label>
                ...
                <div class="col-lg-12 mb-3">
                    ...
                    <asp:Button runat="server" ID="btnNew" CssClass="btn btn-info" Visible="false" Text="Add New Whitepaper" OnClick="btnNew_Click" />
