        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-6 mb-2">
                                    <label class="text-muted">Video Link <sup class="text-danger">*</sup></label>
                                ...
                                <div class="col-lg-6 mb-2">
                                    ...
                                    <small class="text-danger fw-bold">Image format .png, .jpeg, .jpg, .webp with 800px w X 548px h is recommended.</small><br />
                                    <%=strThumbImage %>
                                </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="mb-sm-0 card-title">View Video Link</h4>
                        </div>
