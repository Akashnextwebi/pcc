<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="view-whitepaper.aspx.cs" Inherits="Admin_view_whitepaper" %>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">View Whitepaper</h4>
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">View White Paper</h5>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
        ...
        $(document.body).on("click", ".deleteItem", function () {
            ...
            swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        type: 'POST',
                        url: "view-whitepaper.aspx/Delete",
