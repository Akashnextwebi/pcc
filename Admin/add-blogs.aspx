            ...
            <div class="col-lg-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row mb-2">
                            <div class="col-lg-6">
                                <label class="">Blog Title<sup class="text-danger">*</sup></label>
                                <asp:TextBox runat="server" class="form-control mb-2 mr-sm-2 txtName" ID="txtName" placeholder="Blog Title" />
                            ...
                            <div class="col-lg-6">
                                <label class="">Blog URL<sup class="text-danger">*</sup></label>
                                <asp:TextBox runat="server" class="form-control mb-2 mr-sm-2 txtUrl" ID="txtUrl" ReadOnly="true" placeholder="Blog Url" />
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-12 mb-3">
                                <label class="">Blog Image<sup class="text-danger">*</sup></label>
                                <asp:FileUpload ID="BlogImage" runat="server" ToolTip="Maxmimum 1 MB file size" CssClass="form-control"></asp:FileUpload>
                                <small class="text-danger">.png, .jpeg, .jpg, .gif formats are required, Image Size Should be 1200 × 750 px</small><br />
                            </div>
