        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title"><%=Request.QueryString["id"] !=null?"Update":"Add" %> Industries</h5>
                </div>
                <div class="card-body">
                    <div class="row mb-2">
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-4">
                            ...
                            <asp:TextBox runat="server" class="form-control mb-2 mr-sm-2 txtUrl" ID="txtUrl" placeholder="Industry Url" />
