...
<head runat="server">
    <title>Park Controls & Communication Password Recovery</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="Book My Wed" name="author" />
    <!-- App favicon -->
                                        ...
                                        <div class="col-lg-6">
                                            <div class="text-center mt-2">
                                                <a href="/admin" class="d-inline-block auth-logo">
                                                    <img src="assets/images/park-control-logo.png" height="30" />
                                                </a>
                                            </div>
                                            <div class="text-center mt-2">
                                                <h5 class="text-primary">Forgot Password?</h5>
                                                <p class="text-muted">Reset password with Park Controls & Communication Admin</p>
                                            </div>
