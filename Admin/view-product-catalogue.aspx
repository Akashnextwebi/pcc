<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="view-product-catalogue.aspx.cs" Inherits="Admin_view_product_catalogue" %>
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Manage Product catalogue</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="/Admin/">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Product catalogue</a></li>
                            <li class="breadcrumb-item active">Manage catalogue</li>
                        </ol>
                    </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0">Manage Product catalogue</h5>
                    </div>
                    <div class="card-body">
           ...
           $(document.body).on('click', '.deleteItem', function () {
               ...
               Swal.fire({
                   ...
                   if (result.value) {
                       $.ajax({
                           type: 'POST',
                           url: "view-product-catalogue.aspx/Delete",
                           data: "{id: '" + id + "'}",
