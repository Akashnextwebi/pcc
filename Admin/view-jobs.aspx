<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="view-jobs.aspx.cs" Inherits="Admin_view_jobs" %>
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header align-items-center d-flex">
              <h4 class="card-title mb-0 flex-grow-1">View Jobs</h4>
             </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-12">
