...
public partial class video_gallery : System.Web.UI.Page
{
        ...
        try
        {
            ...
            if (video.Count > 0)
            {
                for (int i = 0; i < video.Count; i++)
                {
                    ...
                    strvideogallery += @" <div class='col-lg-4 col-md-6'>
                          <div class='service-card'>
                              <div class='card-inner'>

                                  <div class='image'>
                                      <div class='icon'>
                                          <a href='"+ video[i].VideoLink + @"' class='video-i popup-video' contenteditable='false' style='cursor: pointer;'>
    ...
    <a href='"+ video[i].VideoLink + @"' class='video-i popup-video custom-btn' contenteditable='false' style='cursor: pointer;'>Watch Now</a>
</div>
                              </div>
                          </div>
                      </div>
