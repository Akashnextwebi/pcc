...
public class SeminarDetails
{
    ...
    public static int UpdateSeminarDetails(SqlConnection conSQ, SeminarDetails cat)
    {
        ...
        try
        {
            string query = "Update SeminarDetails Set SeminarTitle=@SeminarTitle,ThumbImage=@ThumbImage,Tag=@Tag,AddedOn=@AddedOn,AddedIp=@AddedIp,AddedBy=@AddedBy,Status=@Status Where Id=@Id ";
            using (SqlCommand cmd = new SqlCommand(query, conSQ))
            {
    ...
    public static int InsertSeminar(SqlConnection conSQ, SeminarDetails cat)
    {
        ...
        try
        {
            string query = "Insert Into SeminarDetails (SeminarTitle,ThumbImage,Tag,AddedOn,AddedBy, AddedIp,Status) values(@SeminarTitle,@ThumbImage,@Tag,@AddedOn,@AddedBy,@AddedIp,@Status) ";
            using (SqlCommand cmd = new SqlCommand(query, conSQ))
            {
                cmd.Parameters.AddWithValue("@SeminarTitle", SqlDbType.NVarChar).Value = cat.SeminarTitle;
                cmd.Parameters.AddWithValue("@ThumbImage", SqlDbType.NVarChar).Value = cat.ThumbImage;
