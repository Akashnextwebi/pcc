<%@ Page Title="" Language="C#" MasterPageFile="./MasterPage.master" AutoEventWireup="true" CodeFile="sea.aspx.cs" Inherits="sea" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="breadcrumb-section" style="background-image: linear-gradient(270deg, rgba(0, 0, 0, .55), rgba(0, 0, 0, 0.55) 101.02%), url(image/liv/c1.png );">
    ...
    <div class="section-padding">
        <div class="container">
            <div class="row">
                <div class="col-lg-10">
                    <h2>Sea for PCC: Park Control Communication
...
<p>L Band & S Band 2-Way Power Dividers are RF components designed to evenly split or combine power signals in telemetry and communication systems. They operate within the L Band (1–2 GHz) and S Band (2–4 GHz), making them crucial for aerospace, defense, and satellite applications requiring precise signal distribution.</p>
    ...
    <div class="horizontal-scrolling-section ">
        <div class="single-scroll-container" style="background-image: linear-gradient(180deg, rgb(0 0 0 / 58%) 0%, rgb(0 0 0 / 20%) 100%), url(image/liv/c2.png)">
            <div class="container-fluid one pl--95">
                                    ...
                                    <ul class="nav nav-tabs" id="myTab2" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link active" id="technology-tab" data-bs-toggle="tab" data-bs-target="#technology" type="button" role="tab" aria-controls="technology" aria-selected="true">
                                                <img src="image/liv/111.png" height="120" />
                                        ...
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="finance-tab" data-bs-toggle="tab" data-bs-target="#finance" type="button" role="tab" aria-controls="finance" aria-selected="false" tabindex="-1">
                                                <img src="image/liv/222.png" height="120" />
                                        ...
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="human-tab" data-bs-toggle="tab" data-bs-target="#human" type="button" role="tab" aria-controls="human" aria-selected="false" tabindex="-1">
                                                <img src="image/liv/333.png" height="120" />
                                        ...
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="management-tab" data-bs-toggle="tab" data-bs-target="#management" type="button" role="tab" aria-controls="management" aria-selected="false" tabindex="-1">
                                                <img src="image/liv/444.png" height="120" />
                                    ...
                                    <div class="tab-content" id="myTabContent2">
                                        <div class="tab-pane fade active show" id="technology" role="tabpanel" aria-labelledby="technology-tab">
                                            <div class="eg-card3 two">
                                                <div class="card-img">
                                                    <img src="image/liv/111.png" class="w-100" alt="">
                                                </div>
                                        ...
                                        <div class="tab-pane fade" id="finance" role="tabpanel" aria-labelledby="finance-tab">
                                            <div class="eg-card3 two">
                                                <div class="card-img">
                                                    <img src="image/liv/222.png" class="w-100" alt="">
                                                </div>
                                                <div class="card-content">
                                        ...
                                        <div class="tab-pane fade" id="human" role="tabpanel" aria-labelledby="human-tab">
                                            <div class="eg-card3 two">
                                                <div class="card-img">
                                                    <img src="image/liv/333.png" class="w-100" alt="">
                                                </div>
                                                <div class="card-content">
                                        ...
                                        <div class="tab-pane fade" id="management" role="tabpanel" aria-labelledby="management-tab">
                                            <div class="eg-card3 two">
                                                <div class="card-img">
                                                    <img src="image/liv/444.png" class="w-100" alt="">
                                                </div>
                                                <div class="card-content">
